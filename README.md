[![Repo Checks](https://github.com/sta663-sp26/project_vivo60/workflows/Repo%20Checks/badge.svg)](https://github.com/sta663-sp26/project_vivo60/actions?query=workflow:%22Repo%20Checks%22)


Statistical Computing and Computation - Final Project
-----------

Completed final project is due by 11:59 pm on Tuesday, April 28th.
...
1. Make sure you update your `pyproject.toml` to include any packages that you are using for your project.

1. We have included a basic GitHub Action, `.github/workflows/repo_checks.yml`, that attempts to render your project - this is not a requirement so if it fails you are welcome to directly modify the file and or delete it completely.